...
const PlaylistSearchResults = ({ onBack, searchQuery, setSearchQuery, setCurrentScreen, addSongToPlaylist, currentPlaylistName, setCurrentPlaylistName, onSavePlaylist }) => {
...
return (
    <div className="relative">
      ...
      <div className="absolute top-[350px] absolute left-[370px] w-full p-4 opacity-80 transition duration-300 ease-in-out hover:filter hover:brightness-110">
...
<div className="absolute top-[455px] left-[370px] overflow-y-auto max-h-[200px] p-4">
